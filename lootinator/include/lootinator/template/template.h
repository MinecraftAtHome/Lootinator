...
namespace loot {
	struct TemplateParameters {
		...
		std::map<std::string, uint32_t> itemname_to_id; // TODO maybe reverse mapping and use a
														// vector instead? LootTable loot_table;
	...
	class Template {
	  protected:
		...
		// - add array of constants to memory: either CPU, global, global-shared, managed, or
		// constant
