...
{
    {
        ...
        data::LootTableRoot root = data::LootTableRoot(loot_table_json, "../../lootinator/tests/data/item_map_rp.txt", mc::VersionRange::MC_1_16_TO_1_20);
    }
    {
...
static void correctness_test_enchant_randomly_list()
{
    ...
    nlohmann::json loot_table_json = nlohmann::json::parse(f);
    data::LootTableRoot root = data::LootTableRoot(loot_table_json, "../../lootinator/tests/data/item_map_bastion.txt", mc::VersionRange::MC_1_16_TO_1_20);
