...
namespace mc {
    ...
    std::unordered_map<mc::Enchantment, std::function<bool(int, int)>> ENCHANT_LEVEL_VALIDATORS({
        { NO_ENCHANTMENT,        [](int i, int n){ (void)i;(void)n; return false; } },
        ...
        { AQUA_AFFINITY,         [](int i, int n){ (void)i; return n >= 1 && n <= 41; } },
        ...
        { CURSE_OF_BINDING,      [](int i, int n){ (void)i; return n >= 25 && n <= 50; } },
        ...
        { FLAME,                 [](int i, int n){ (void)i; return n >= 20 && n <= 50; } },
        { INFINITY_ENCHANTMENT,  [](int i, int n){ (void)i; return n >= 20 && n <= 50; } },
        ...
        { CHANNELING,            [](int i, int n){ (void)i; return n >= 25 && n <= 50; } },
        { MULTISHOT,             [](int i, int n){ (void)i; return n >= 20 && n <= 50; } },
        ...
        { CURSE_OF_VANISHING,    [](int i, int n){ (void)i; return n >= 25 && n <= 50; } },
